...
Favorite.create!([
  {user_id: 1, favorited_id: 1, favorited_type: "Product"},
  {user_id: 1, favorited_id: 2, favorited_type: "Product"},
  {user_id: 2, favorited_id: 1, favorited_type: "Product"},
  {user_id: 1, favorited_id: 9, favorited_type: "Product"},
  {user_id: 2, favorited_id: 3, favorited_type: "Product"},
  {user_id: 1, favorited_id: 4, favorited_type: "Product"},
  {user_id: 1, favorited_id: 3, favorited_type: "Product"}
])
Product.create!([
